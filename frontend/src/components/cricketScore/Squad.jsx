    ...
    <>
      ...
      <div className='w-[80%] mx-auto shadow-xl shadow-[#b0afaf] my-4 border-[1px]'>
        <div className='flex justify-between px-4 py-2 m-2 rounded-[5px] bg-[#cae8f2]'>
            <strong>{squad[0]?.teamName}</strong>
            <strong>{squad[1]?.teamName}</strong>
        </div>
        <div className='w-full'>
            ...
            <div className='flex justify-between items-center text-left border-[1px]'>
                <div className='flex-[0.5] flex flex-col items-center border-[1px]'>
                {
                  squad[0]?.players?.map((player,index)=>(
                    <div >
                      <img src={player?.playerImg} alt="png" className='w-14 h-14 rounded-full p-2'/>
                      <div className='ml-2'>
                          <span className='block'>{player?.name} (C)</span>
                          <span className='block'>{player?.Batsman}</span>
                      </div>
                    </div>
                  ))
                }
                ...
                <div className='flex-[0.5] flex flex-col items-center border-[1px]'>
                {
                  squad[1]?.players?.map((player,index)=>(
                    <div >
                      <img src={player?.playerImg} alt="png" className='w-14 h-14 rounded-full p-2'/>
                      <div className='ml-2'>
                          <span className='block'>{player?.name} (C)</span>
